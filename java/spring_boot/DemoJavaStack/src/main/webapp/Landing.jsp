...
<div class="w-[88%] mx-auto my-10">
    <h1 class="mb-5 text-5xl text-center text-blue-500">Project Manager</h1>
    <h1 class="text-2xl text-center">A place For Teams to manage projects</h1>
</div>
...
<div class="mx-auto h-200 w-[90%] justify-between flex mt-10">
    <div class="w-[45%]">
        <form:form action="/adduser" method="post" modelAttribute="newUser">
            ...
            <div class=" m-5">
                <div class="flex justify-between">
                    <form:label cssClass="text-4xl" path="lastName">Name</form:label>
